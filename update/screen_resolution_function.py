from update.constant import MINIMAL_SUPPORTED_RESOLUTION_WIDTH_HEIGHT, MAIN_WINDOW_RESOLUTION

screen_resolution_width, screen_resolution_height = None, None
horizontal_position_on_screen, vertical_position_on_screen = None, None


def get_and_save_screen_resolution(root_tkinter_tk):
...
def calculating_the_middle_position_on_screen():
    global horizontal_position_on_screen, vertical_position_on_screen
